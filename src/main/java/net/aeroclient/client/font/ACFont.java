...
public class ACFont {
    ...
    public ACFont(ResourceLocation resourceLocation, float size) {
        Font tmp;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation(resourceLocation.getResourcePath())).getInputStream();
